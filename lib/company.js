...
/**
 * Company - Used for communication with intercomClient's company object
 * @class
 * @author Ryan Kahn
 */
class Company {
  ...
  constructor (orion) {
    this.orion = orion
    if (!this.orion.canUseIntercom()) { return }
    this.intercomClient = this.orion.intercomClient
  }
  ...
  _wrap (method) {
    ...
    args.shift()
    return this.intercomClient.companies[method].apply(this.intercomClient, args)
  }
